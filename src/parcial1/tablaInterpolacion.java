...
public class tablaInterpolacion extends javax.swing.JFrame {
    double x, x0, x1, er, f_x, f_x0, f_x1, fx_final;
    Proceso objeto= new Proceso();
    public tablaInterpolacion() {
        this.setTitle("Interpolacion");
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("F(X0):");

        jLabel6.setText("F(X1):");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        f_x= Double.parseDouble(jTextField4.getText());
        f_x0= Double.parseDouble(jTextField5.getText());
        f_x1= Double.parseDouble(jTextField6.getText());
        fx_final= (f_x0 + ((f_x1 - f_x0)/(x1 - x0))) * (x - x0);
        er= objeto.RedoNumero((Math.abs((f_x - fx_final) / f_x))*100);
        jTextField7.setText(""+er);
